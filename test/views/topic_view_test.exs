defmodule TheLeanCafe.TopicViewTest do
  ...
  test "renders single topic html" do
    ...
    assert render_to_string(TopicView, "show.html", topic: topic, dot_votes: 0, hide_votes: false) =~
  ...
  test "hides vote button if state is brainstorm" do
    topic = %Topic{id: 123, name: "Some cool topic"}
    refute render_to_string(TopicView, "show.html", topic: topic, dot_votes: 0, hide_votes: true) =~
       ~r/onclick="window.dotVote/s
  end

  test "shows correct vote count" do
    topic = %Topic{id: 123, name: "Some cool topic"}
    assert render_to_string(TopicView, "show.html", topic: topic, dot_votes: 456, hide_votes: false) =~
       ~r/456/s
  end
  ...
  test "renders list of topics within table" do
    ...
    assert render_to_string(TopicView, "index.html", topics_and_dot_votes: topics_and_dot_votes, hide_votes: false) =~
